...
function earlyVLate(bowlingBall) {
    ...
    var value = -6.47374266160808*rg*(rg - 2.6206777)*(40.24794*rg - 102.008559443964) + 3.8247962*diff/(diff - 0.008874497) + mb_diff/(23.5564009150368*mb_diff - 0.437239903099248) + 0.0016090363*finish - (62666.91*mb_diff**2/(Math.sin(605.0254*mb_diff) + 1.977454) - 3.2504096)*Math.sin(2.1269627*Math.sin(3.469686*finish)) + 7.372996*Math.sin(4538.579*mb_diff*(mb_diff - 0.007848568)*(Math.sin(Math.exp(rg)) + 0.28085837)) + 62.4810893192692 + 0.082332864/(rg - 2.6865366) + Math.sin(17.5679517834212*diff - 0.6231852)/(0.07006618 - Math.sin(0.16966921*finish)) - 20341.42/finish - 0.201301930851112/diff
    return value;
}
...
function smoothVAngular(bowlingBall) {
    ...
    var value = 38.864967*rg - 120.41707*diff + mb_diff**2*finish/(Math.sin(2*finish) - 0.30317035) - 26727.46*mb_diff*(0.6001752 - Math.sin(rg))*(rg - 2.8211472)*Math.sin(136.74153*mb_diff - 1.1881695) - 53.6438007641345*mb_diff*(478.58905056212*mb_diff - 8.92158189187496) - mb_diff - 3.84479141255288 - 733.2708/(finish - 2355.4263) + 0.002088377/(mb_diff - 0.018642792) + 0.893783/(37.864967*rg - 99.208786) + 7.7535615*(2.7794487*finish - 4235.434)/finish + 8319183.0*Math.sin(1.5752895 + 0.049962416/diff)/finish**2 + (-1.1900324 + 0.008265728/diff)/diff
    return value;
}
